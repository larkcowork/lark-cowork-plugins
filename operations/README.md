...
| **Project tracker** | Lark Task, Lark Task, Lark Base | Project status, resource allocation, task tracking |
| **Knowledge base** | Lark Wiki, Lark Wiki | Process docs, runbooks, policies |
| **Chat** | Lark IM, Teams | Team coordination, approvals, status updates |
| **Calendar** | Lark Calendar, Lark | Meeting scheduling, deadline tracking |
| **Email** | Lark Mail, Lark | Vendor communications, approvals |
