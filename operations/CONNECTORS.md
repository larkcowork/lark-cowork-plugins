...
| ITSM | `~~ITSM` | ServiceNow (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
...
| Procurement | `~~procurement` | external MCP (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
