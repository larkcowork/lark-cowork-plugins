...
| Design | `~~design` | Canva, Figma (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| Marketing automation | `~~marketing automation` | HubSpot (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| Product analytics | `~~product analytics` | Amplitude (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| Knowledge base | `~~knowledge base` | Lark Wiki + Docs (`lark`) | `lark_doc_search`, `lark_doc_fetch`, `lark_doc_create` |
| SEO | `~~SEO` | Ahrefs, Similarweb (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| Email marketing | `~~email marketing` | Klaviyo (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| Marketing analytics | `~~marketing analytics` | Supermetrics (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
