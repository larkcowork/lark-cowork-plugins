...
| **Project tracker** | Lark Task, Lark Task, Lark Task | Link designs to tickets, track implementation |
| **Knowledge base** | Lark Wiki | Brand guidelines, design principles, research repository |
