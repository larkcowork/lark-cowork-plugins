...
| Design tool | `~~design tool` | Figma (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
...
| Product analytics | `~~product analytics` | external MCP (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
