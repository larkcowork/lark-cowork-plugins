...
- Lives in an official "Brand" folder or Lark Wiki space
- Has version numbers or approval dates
- Referenced by other documents as "the brand guide"

**Examples:**
- "Acme Corp Brand Guidelines v3.2.pdf"
- "Official Style Guide" page in Lark Wiki Marketing space
- Brand book in Lark Drive with company-wide sharing
...
**Source: "Brand Voice Guidelines v3.2" (Lark Wiki, updated 3 months ago)**
