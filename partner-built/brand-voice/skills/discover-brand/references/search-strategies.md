...
## Lark Wiki (Primary Discovery Engine)

Lark Wiki AI Search federates across connected sources (Lark Drive, SharePoint, OneDrive, Lark IM, Lark Task, Teams), making it the most valuable single search endpoint.
...
### Tips
- Lark Wiki AI Search returns results from connected sources — one search covers multiple platforms
...
Enterprises often store official brand documentation in Lark Wiki spaces.
...
### Tips
- Lark Wiki spaces often have hierarchical page trees — find the brand root page and explore children
...
- Search attachments for PDF brand guides uploaded to Lark Wiki pages
...
Lark Drive stores shared brand documents, marketing materials, and official style guides.
...
Lark IM channels contain informal brand discussions, decisions, and evolving brand voice patterns.
...
- Lark IM is a conversational source — ranks as CONVERSATIONAL tier in source triage
...
### Maximizing Coverage
1. Start with Lark Wiki AI Search (broadest coverage via federation)
2. Follow up with Lark Wiki for enterprise documentation
3. Check Lark Drive for official brand documents
4. Check Box for cloud-stored brand documents
5. Search SharePoint/OneDrive for enterprise files
6. Search Lark IM for brand discussions and decisions
...
- Note when Lark Wiki federation returns results from other platforms to avoid double-searching
