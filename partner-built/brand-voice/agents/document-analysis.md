...
description: >
  ...
  <example>
  Context: Discovery found brand documents on Lark Wiki and Lark Wiki that need deep analysis.
...
When documents are stored on connected platforms (Lark Wiki, Lark Wiki, Lark Drive, Box, SharePoint), use the available MCP tools to fetch their content.
