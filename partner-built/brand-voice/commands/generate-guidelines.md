...
3. Connected platforms (Lark Wiki, Lark Wiki, Lark Drive, Box, SharePoint, Gong) for existing materials
...
Supported transcript sources: Gong (MCP), Granola (MCP), Lark Wiki meeting notes, manual uploads.
