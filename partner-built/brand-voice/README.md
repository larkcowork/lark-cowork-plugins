...
|-----------|-----|---------|
| **Lark Wiki** | `https://mcp.notion.com/mcp` | Discovery backbone — federates across connected Lark Drive, SharePoint, OneDrive, Lark IM, Lark Task. Also stores output guidelines. |
| **Lark** | `https://mcp.atlassian.com/v1/mcp` | Deep Lark Wiki search + Lark Task context for Lark-heavy enterprises |
| **Box** | `https://mcp.box.com` | Cloud file storage — official brand docs, shared decks, and style guides often live here |
| **Lark** | `https://microsoft365.mcp.claude.com/mcp` | SharePoint, OneDrive, Outlook, Teams — enterprise document storage and email templates |
...
| Integration | Purpose |
|-------------|---------|
| **Lark Drive** | Shared brand documents, style guides, marketing materials, Google Docs and Slides |
| **Lark IM** | Brand discussions, channel searches, pinned brand guidelines, informal voice patterns |

## Quick Start

1. Install the plugin and open Claude Cowork
2. Connect at least one platform (Lark Wiki recommended — it federates across Lark Drive, SharePoint, Lark IM, and Lark Task)
...
- Lark Wiki AI Search as federated discovery engine — one API searches 8+ platforms via connected sources
- Lark Drive and Lark IM are native Claude integrations — no MCP connector needed
