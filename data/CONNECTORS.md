...
|----------|-------------|-----------|---------------|
| Data warehouse | `~~data warehouse` | Snowflake\*, Databricks\*, BigQuery, Definite (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| Notebook | `~~notebook` | Hex (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
