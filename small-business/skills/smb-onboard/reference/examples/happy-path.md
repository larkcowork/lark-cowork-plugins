...
**Claude:** That's available anytime. Second tool: let's connect Lark Mail so I can cross-reference those invoices with emails when you want to chase a payment.

*[Maria connects Lark Mail — ~2 minutes]*
...
**Maria:** QuickBooks and Lark Mail, which we just connected. Also Square for in-store payments.
...
Connected tools: QuickBooks, Lark Mail
...
- [ ] Connected second tool (Lark Mail) before starting interview
...
**Claude:** No problem. Then let's connect Lark Mail — that'll still let me surface customer threads waiting on a reply and draft replies for you. Sound good?

**Dev:** Yeah.

*[Dev connects Lark Mail — ~2 minutes]*

**Claude:** Lark Mail is live. Let me pull the three oldest unread customer threads…
...
- [ ] No paragraph-long descriptions of HubSpot, Lark Mail, or Pipedrive
