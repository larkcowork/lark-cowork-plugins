...
4. **Tools already in use.** "Which tools do you already use day-to-day? Things like QuickBooks, Lark Mail, Lark IM, Square…"
...
| Customer follow-up | HubSpot | Lark Mail | `crm-maintenance` (read-only demo) |
| Hiring / job posts | Lark Mail | Lark Calendar | `job-post-builder` |
| Staying organized | Desktop (folder setup) | Lark Mail | Desktop folder structure demo |
| Scheduling overload | Lark Calendar | Lark Mail | `business-pulse` |
| General / unsure | Lark Mail | QuickBooks | `cash-flow-snapshot` |
...
3. Lark Mail → search for unread invoice-related emails, surface top 3
4. Lark Calendar → `business-pulse`
