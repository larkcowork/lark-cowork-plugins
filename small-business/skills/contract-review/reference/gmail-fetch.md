# Lark Mail: finding contract attachments

Use the Lark Mail MCP connector to find contract attachments in recent email.
...
If Lark Mail is not connected or no matching attachment is found:

```
"I didn't find a recent contract attachment in Lark Mail — can you forward it or attach the file directly?"
```
