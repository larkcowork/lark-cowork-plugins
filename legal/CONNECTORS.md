...
| CLM | `~~CLM` | external MCP (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| CRM | `~~CRM` | external MCP (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
| Email | `~~email` | Lark Mail (`lark`) | `lark_mail_send`, `lark_mail_draft_create` |
| E-signature | `~~e-signature` | DocuSign (external) | connect this tool's own MCP server; or approximate with Lark Base/Sheets |
